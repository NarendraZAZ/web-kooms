...
export default function LoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Jika input bukan format email (tidak ada @), cari email berdasarkan username di public.profiles
      ...
      // Cek Role Pengguna untuk Redirect yang Tepat
  ...
  return (
    <div className="max-w-md mx-auto my-12 p-8 bg-white border border-stone-200 rounded-3xl shadow-sm space-y-6">
      <div className="text-center space-y-1">
        <h1 className="text-2xl font-black text-orange-600">Masuk KOOMS</h1>
        <p className="text-xs text-stone-500">
          Order Ahead & Pickup Station Kerang OISHII
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="Ketik email atau username (misal: budi_oishii)..."
            value={identifier}
        ...
        <div className="flex justify-between items-center border-t border-stone-100 pt-4 text-xs">
